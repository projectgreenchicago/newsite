            ...
            <Col md="7" className="text-center">
              ...
              >
                <h5 className="subtitle">
                  Here are the steps to make your incentive rebate process
                  pain-free
                </h5>
              </AnimationOnScroll>
            </Col>
                ...
                <Card>
                  <Row>
                    <Col md="3" className="text-center">
                      <a
                        href="#"
                        className="text-white linking bg-success-gradiant h-100"
                      >
                        STEP 1
                      </a>
                    </Col>
                      ...
                      <CardBody className="d-flex no-block my-auto h-100">
                        <div className="my-auto">
                          <h5 className="font-medium">
                            You reach out to us and tell us about your site.
                          </h5>
                        </div>
                      </CardBody>
                    </Col>
                  ...
                  <Row>
                    ...
                    <Col md="8">
                      <CardBody className="d-flex no-block my-auto h-100">
                        <div className="my-auto">
                          <h5 className="font-medium">
                            We analyze your case and design a plan to minimize
                            your costs and maximize rebates.
                          </h5>
                        </div>
                      </CardBody>
                    </Col>
                  ...
                  <Row>
                    ...
                    <Col md="8">
                      <CardBody className="d-flex no-block my-auto h-100">
                        <div className="my-auto">
                          <h5 className="font-medium">
                            We take care of the installation and you start
                            saving money.
                          </h5>
                        </div>
                      </CardBody>
              ...
              <div className="game-plan-cta">
                ...
                >
                  <AnchorLink
                    ...
                    href={"#contact-us"}
                    onClick={() => {
                      sendMetrik("click", "how-much-can-i-save");
                    }}
                  >
                    <span>
                      HOW MUCH CAN I SAVE? <i className="ti-arrow-right"></i>
                    </span>
                  </AnchorLink>
                </AnimationOnScroll>
              </div>
