...
const LoginComponent = (props) => {
  ...
  return (
    <div>
      <Header view="sign-in" />
      {!currentUser ? (
        <div style={{ height: "50vh", marginTop: "5%" }}>
          <Container className="spacer mt-5 text-center p-b-0">
            ...
            {haveAccount ? (
              <div className="d-flex justify-content-center">
                <p className="subtitle">Don't have an account?</p>&nbsp;
                <a onClick={handleClick} className="text-info">
                  Sign up!
                </a>
              </div>
            ) : (
        ...
        <div>
          <Container className="mt-5 spacer text-center p-b-0">
            ...
            >
              <span>
                Sign Out <i className="ti-arrow-right"></i>
              </span>
            </Button>
          </Container>
        </div>
