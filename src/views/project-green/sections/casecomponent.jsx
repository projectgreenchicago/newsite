        ...
        <Container className="mb-5">
          <Row className="justify-content-center mb-4">
            <h2 className="text-center">
              Here's how we assisted our recent customer:
            </h2>
          </Row>
          <LazyLoad height={0}>
            ...
            <Col lg="6" md="7" className="text-center wrap-case-box">
              ...
              >
                <Card className="card-shadow">
                  <CardBody>
                    <div className="p-20">
                      <span className="label label-info label-square">
                        Recent Customer
                      </span>
                      ...
                      <h4 className="subtitle text-left mt-3">
                      ...
                      <h5 className="subtitle text-left text-success">
                        $ 2,346
                      </h5>
                      <AnchorLink
                        ...
                        href={"#contact-us"}
                        onClick={() => {
                          sendMetrik("click", "maximize-savings-case");
                        }}
                      >
                        <span>
