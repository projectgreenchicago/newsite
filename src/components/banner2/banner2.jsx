            ...
            <Container>
                <Row className="justify-content-center">
                    <Col lg="10" md="6" className="align-self-center text-center">
                        ...
                        <Link to={"#contact-us"} className="btn btn-outline-light m-r-20 btn-md m-t-30 font-14">Contact Us</Link>
                        <Link to={"#contact-us"} className="btn btn-md m-t-30 btn-info-gradiant font-14">GET FREE REBATE ASSESSMENT</Link>
                    </Col>
                </Row>
            </Container>
        </div>
